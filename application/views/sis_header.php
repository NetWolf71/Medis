...
<div class="container-fluid" align="right">
	...
	<a class="btn btn-danger btn-sm" href="<?=base_url('index.php/Inicio/cerrar_sesion')?>"> Cerrar Sesión <em class="glyphicon glyphicon-log-out"></em></a>
			...
			<nav class="navbar navbar-default">
			  ...
			  <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
				...
				<ul class="nav navbar-nav">
				  ...
				  <?php
					if($_SESSION['pers_tipo_nombre']=='ADMINISTRADOR'){
				  ...
				  ?>
				  <?php if ($_SESSION['pers_tipo_nombre']=='MEDICO'	||		
							$_SESSION['pers_tipo_nombre']=='ADMINISTRADOR'
							)
				  {
					?>
				  ...
				  <?php if ($_SESSION['pers_tipo_nombre']=='PACIENTE' || 	
							$_SESSION['pers_tipo_nombre']=='ADMINISTRADOR' ||
							$_SESSION['pers_tipo_nombre']=='USUARIO'					
							)
				  {
					?>
				  <li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">Buscar Horas Médicas
					<span class="caret"></span></a>
					<ul class="dropdown-menu">
					  <li><a href="<?=base_url('index.php/ReservaMedController')?>">Búsqueda por Medico o Especialidades</a></li>
					</ul>
				  </li>			 
				  <li><a href="<?=base_url('index.php/MisReservasController/ver/')?><?php echo $_SESSION['id_pers'];?>">Mis Reservas de horas</a></li>
				  <?php
				  }
				  ?>
				  
				  <li><a href="<?=base_url('index.php/MiCuentaController/ver/')?><?php echo $_SESSION['id_pers'];?>">Mi Cuenta</a></li>
				  <li><a href="<?=base_url('index.php/ContactController')?>">Contáctanos</a></li>
				</ul>
			  </div>
			  </div>
			</nav>
