...
<div class="container-fluid" style= 'text-align:center'>
	<br/><h3>INGRESAR NUEVO MEDICO</h3>
</div>

<div class="container-fluid" style= 'text-align:left'>
	<div class="table-responsive" >
		<form action="<?=base_url("index.php/MedicosController/add");?>" method="post">
			<table class="table table-hover table-bordered">				
				...
				<tr align="center">
					...
					<td>
						...
						<input type="submit"  class="btn btn-md btn-success" name="submit" value="Ingresar Nuevo Médico" style= 'text-align:center'/>
						<a class="btn btn-warning" href=<?=base_url("index.php/MedicosController")?>>Volver a Médicos</a></>
						</div>
		</form>
	</div>
</div>
